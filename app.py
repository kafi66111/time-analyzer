...
if st.button(النصوص[اللغة]["analyze"]):
    try:
        ...
        if مجموع == 0:
            ...
            التصنيفات = [النصوص[اللغة]["sleep"], النصوص[اللغة]["phone"], النصوص[اللغة]["study"], النصوص[اللغة]["waste"]]
            ...
            توصيات = النصوص[اللغة]["analysis"]
            توصيات += "\n" + (النصوص[اللغة]["sleep_low"] if نوم < 6 else النصوص[اللغة]["sleep_ok"])
            توصيات += "\n" + (النصوص[اللغة]["phone_high"] if هاتف > 3 else النصوص[اللغة]["phone_ok"])
            توصيات += "\n" + (النصوص[اللغة]["study_low"] if دراسة < 4 else النصوص[اللغة]["study_ok"])
            توصيات += "\n" + (النصوص[اللغة]["waste_high"] if ضائع > 3 else النصوص[اللغة]["waste_ok"])
            توصيات += "\n" + النصوص[اللغة]["tips"]
